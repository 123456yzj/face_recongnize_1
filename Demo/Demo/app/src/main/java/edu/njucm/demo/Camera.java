...
public class Camera extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            imageUri = FileProvider.getUriForFile(this, "com.example.android.choosepicdemo.fileprovider", outputImage);
            Log.d("Activity1_1", outputImage.toString() + "手机系统版本高于Android7.0");
        } else {
            // 将File对象转换为Uri对象，这个Uri标识着output_image.jpg这张图片的本地真实路径
            Log.d("Activity1_1", outputImage.toString() + "手机系统版本低于Android7.0");
        ...
        intent3_1 = new Intent(getApplicationContext(),Activity1_1.class);
    ...
    private void startCamera() {
        Intent intent4_1 = new Intent("android.media.action.IMAGE_CAPTURE");
        // 指定图片的输出地址为imageUri
        intent4_1.putExtra(MediaStore.EXTRA_OUTPUT, imageUri);
        startActivityForResult(intent4_1, TAKE_PHOTO);
    }
